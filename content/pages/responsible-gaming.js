...
module.exports = {
  ...
  metaDescription:
    "55 Club's Responsible Gaming page template: plain-language guidance on healthy play habits, warning signs, self-exclusion patterns and where to find real help.",
  build() {
    return renderStandardPage({
      ...
      hero: {
        ...
        lead: "This page is written in full, not stubbed out — genuine guidance on healthy play habits, warning signs worth taking seriously, and where to find real support if gaming stops feeling like entertainment.",
        primary: { label: "Customer Support", href: "/customer-support/" },
        secondary: { label: "About", href: "/about/" },
      },
      intro: [
        "Every other page on this site is a design and content template describing a placeholder brand. This page is the one place that departs from pure template framing to say something plainly and sincerely: gaming and gambling-style entertainment should stay entertainment. If it stops feeling like a choice and starts feeling like something harder to control, that's worth taking seriously and acting on, not minimizing.",
        "This template treats that message as core content, not legal boilerplate tacked on to satisfy a checklist. The sections below cover what healthy play generally looks like, warning signs that are worth paying attention to, tools like deposit limits and self-exclusion that real platforms typically offer, and where to look for actual professional support — because a page like this exists to help, not just to disclaim liability.",
        "A general but important disclaimer: 55 Club, as described throughout this site, is a placeholder brand and design template. It does not operate as a real gaming platform and does not process real registrations, deposits or withdrawals. If you are engaging with any real-money gaming platform — this one's namesake or any other — verify it holds legitimate licensing for your jurisdiction, and hold it to the standard of transparency this page describes.",
      ...
      extraSection: {
        ...
        paragraphs: [
          "Most licensed real-money gaming platforms offer account-level tools worth knowing about, even in a template context: deposit limits that cap spending over a set period, session time reminders, cooling-off periods that temporarily restrict access, and full self-exclusion for longer-term breaks. If you're using a real platform, look for these tools in account settings — a legitimate operator makes them easy to find, not buried.",
          ...
          "If gaming is affecting your finances, relationships or wellbeing, reaching out to one of those independent resources is a stronger first step than trying to manage it through willpower alone. There's no template language that substitutes for real support, and this page won't pretend otherwise.",
        ],
      },
      relatedLinks: {
        title: "Related Pages",
      ...
      faq: {
        items: [
          ...
          { q: "Is 55 Club a real gaming platform I can use?", a: "No — as stated throughout this site, 55 Club is a placeholder brand and design template. It does not process real registrations, deposits or withdrawals." },
